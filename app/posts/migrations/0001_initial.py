    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complex_type', models.CharField(max_length=10, null=True, verbose_name='단지 타입')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posts.ComplexInformation', verbose_name='추천 단지')),
            ],
        ),
    ]
